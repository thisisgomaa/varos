...
2. License your contribution under GPL-3.0, **and additionally grant the project maintainer (Ahmed Gomaa) a perpetual, irrevocable right to relicense your contribution** as part of future Varos releases (this keeps options like store builds and commercial licensing open without hunting down every past contributor).

If you're not comfortable with clause 2, open an issue and we'll talk before you write code.
