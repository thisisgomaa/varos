...
/// The dummy Board: warm-black canvas + dotted grid (mockup 22px). The two floating hands land here in Stage 3.
fn draw_board(ui: &mut egui::Ui, rect: egui::Rect) {
    ...
    p.text(rect.center(), Align2::CENTER_CENTER, "board", FontId::proportional(13.0), T::FAINT);
}
